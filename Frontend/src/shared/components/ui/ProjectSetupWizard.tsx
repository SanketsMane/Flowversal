 ...
 * Reusable wizard for configuring any project (template-based or manually created)
 * Can be opened at any time to update project settings
 */
      ...
      case 0: // Basic Information
        return (
          <div className="space-y-6">
            <div>
              <h3 className={`text-xl ${textPrimary} mb-4`}>Let's set up your project</h3>
              <p className={`${textSecondary} mb-6`}>
                Provide some basic information about your project. You can always update this later.
              </p>
            </div>
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className={`${textSecondary} mb-6`}>
                Add API keys for third-party services. All fields are optional and can be configured later.
              </p>
            </div>
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className={`text-2xl ${textPrimary}`}>
                {isInitialSetup ? 'Project Setup' : 'Update Project Setup'}
              </h2>
              <p className={`text-sm ${textSecondary} mt-1`}>{project.name}</p>
            </div>
            <button
              onClick={onClose}
