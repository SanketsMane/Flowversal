  ...
  useEffect(() => {
    ...
    connections.forEach((connection) => {
      ...
      if (sourceDot && targetDot) {
        ...
        console.log('🟢 DOT POSITIONS:', {
          sourceId: connection.sourceId,
          targetId: connection.targetId,
          sourceDot: {
            rect: { left: sourceRect.left, top: sourceRect.top, width: sourceRect.width, height: sourceRect.height },
          ...
          targetDot: {
            ...
            center: { x: targetRect.left + targetRect.width / 2, y: targetRect.top + targetRect.height / 2 },
            relative: { x: x2, y: y2 }
          },
