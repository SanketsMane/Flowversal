...
export function RunWorkflowButton({ workflowId: propWorkflowId, variant = 'default', iconOnly = false }: RunWorkflowButtonProps) {
  ...
  const handleRun = async () => {
    console.log('[DEBUG] RunWorkflowButton: handleRun called', { propWorkflowId, routeWorkflowId: routeParams.id || routeParams.workflowId, finalWorkflowId: workflowId });
    // #region agent log
    ...
    console.log('[DEBUG] RunWorkflowButton: executeWorkflow result', { result });
    // #region agent log
