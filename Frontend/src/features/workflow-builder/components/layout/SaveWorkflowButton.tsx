  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (workflowId) {
        ...
        console.log('[Save Workflow] Updating workflow:', workflowId);
        ...
        // Create new workflow
        console.log('[Save Workflow] Creating new workflow...');
        ...
        console.log('[Save Workflow] Workflow created:', savedWorkflowId);
        ...
        try {
          ...
          console.log('[Save Workflow] Workflow indexed to Pinecone');
        } catch (indexError) {
